...
static const char *fonts[]          = { "DejaVuSansMono Nerd Font:size=11", "Noto Color Emoji:size=10", "DejaVuSansMono:size=11" };
...
static const char col_green[]       = "#2e6039";
